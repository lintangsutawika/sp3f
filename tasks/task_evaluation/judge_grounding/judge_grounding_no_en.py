...
class JGTask(YevalTask):
    ...
    data_path="json"
    data_name=None
    input_text=lambda x: f"""You will be given an English text and two responses. \
Your task is to choose which response is better based on the following considerations:
1. The response MUST be fluent and coherent in Indonesian.
2  The response MUST NOT be in English. 
3. The response MUST be factually correct.
...
@register_task("judge_grounding_no_en_1A")
