...
#SBATCH --exclude=babel-9-3,babel-4-25,babel-14-29,babel-12-9,babel-13-1,babel-7-1,babel-13-13,babel-10-9,babel-7-9

. ./lang_boot/config/.env

while getopts ":a:m:l:n:t:d:s:f:r:v:g:e:j:p:w:y:o:b:z:i:" opt; do
  case ${opt} in
